...
write.csv(Emaster,file="Emaster.csv",row.names=FALSE)
...
write.csv(Wmaster,file="Wmaster.csv",row.names=FALSE)
...
write.csv(Hmaster,file="Hmaster.csv",row.names=FALSE)
